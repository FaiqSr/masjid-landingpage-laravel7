    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Pendaftar Belum Berkas</li>
            </ol>
        </div>
    </div>
@endsection
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Daftar Calon Siswa yang Belum Melengkapi Berkas</h3>
        </div>
        <div class="card-body">
            <table id="table1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center">Semua siswa sudah melengkapi berkas.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
